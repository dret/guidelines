...
* Nederlandse API Designrules: [API Designrules](https://geonovum.github.io/API-Designrules/) and [API Designrules Extensions](https://geonovum.github.io/KP-APIs/API-strategie-extensies)
